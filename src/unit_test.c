...
START_TEST(s21_add_test_13) {
    s21_decimal src1 = {{0x80000000, 0x80000000, 0x80000000, 0}}, src2 = {{2, 0, 0, 0}};
    s21_decimal temp = {{0, 0, 0, 0}};
...
START_TEST(s21_add_test_14) {
    s21_decimal src1 = {{0xffffffff, 0xffffffff, 0xffffffff, 0}}, src2 = {{2, 0, 0, 0x80000000}};
    s21_decimal temp = {{0, 0, 0, 0}};
    int a = s21_add(src1, src2, &temp);
    ck_assert_int_eq(a, 0);
}
...
START_TEST(s21_add_test_15) {
    s21_decimal src1 = {{0xffffffff, 0xffffffff, 0xffffffff, 0}}, src2 = {{0, 0, 0, 2}};
    s21_decimal temp = {{0, 0, 0, 0}};
    int a = s21_add(src1, src2, &temp);
    ck_assert_int_eq(a, 0);
}
...
START_TEST(s21_add_test_16) {
    s21_decimal src1 = {{0xffffffff, 0xffffffff, 0xffffffff, 0b00000000000000001111111000000000}};
    s21_decimal src2 = {{0xffffffff, 0xffffffff, 0, 0b00000000000000001111111000000000}};
    s21_decimal temp = {{0, 0, 0, 0}};
    int a = s21_add(src1, src2, &temp);
...
START_TEST(s21_add_test_17) {
    s21_decimal src1 = {{0xffffffff, 0xffffff00, 0, 0b00000000000000001111111000000000}};
    s21_decimal src2 = {{0xffffffff, 0xffffff00, 0, 0b00000000000000001111111000000000}};
    s21_decimal temp = {{0, 0, 0, 0}};
    int a = s21_add(src1, src2, &temp);
    ck_assert_int_eq(a, 0);
}
...
START_TEST(s21_add_test_18) {
    s21_decimal src1 = {{0xffffffff, 0xffffff00, 0xffffff00, 0}};
    s21_decimal src2 = {{0xffffffff, 0xffffff00, 0, 28 << 16}};
    s21_decimal temp = {{0, 0, 0, 0}};
    int a = s21_add(src1, src2, &temp);
    ck_assert_int_eq(a, 0);
}
...
START_TEST(s21_add_test_19) {
    s21_decimal src1 = {{0xffffffff, 0xffffffff, 0xffffffff, 1 << 31}};
    s21_decimal src2 = {{0xffffffff, 0xffffffff, 0xffffffff, 0}};
    s21_decimal temp = {{0, 0, 0, 0}};
    int a = s21_add(src1, src2, &temp);
    ck_assert_int_eq(a, 0);
}
...
START_TEST(s21_sub_test_10) {
    s21_decimal src1 = {{0x80000000, 0x80000000, 0x80000000, 0}}, src2 = {{2, 0, 0, 0xffffffff}};
    s21_decimal temp = {{0, 0, 0, 0}};
...
START_TEST(s21_sub_test_12) {
    s21_decimal src1 = {{0xffffffff, 0xffffffff, 0xffffffff, 0}}, src2 = {{2, 0x80000000, 0x80000000, 2}};
    s21_decimal temp = {{0, 0, 0, 0}};
    int a = s21_sub(src1, src2, &temp);
    ck_assert_int_eq(a, 0);
}
...
START_TEST(s21_mul_test_9) {
    s21_decimal src1 = {{0x80000000, 0x80000000, 0x80000000, 0}}, src2 = {{2, 0, 0, 0x80000000}};
    s21_decimal temp = {{0, 0, 0, 0}};
...
START_TEST(s21_mul_test_12) {
    s21_decimal src1 = {{0xffffffff, 0xffffffff, 0xffffffff, 0}}, src2 = {{2, 0, 0xffffffff, 0}};
    s21_decimal temp = {{0, 0, 0, 0}};
    int a = s21_mul(src1, src2, &temp);
    ck_assert_int_eq(a, 1);
}
...
START_TEST(s21_mul_test_14) {
    ...
    s21_decimal src2 = {{0xffffffff, 0xffffffff, 0xffffffff, 28 << 16}};
    s21_decimal temp = {{0, 0, 0, 0}};
    int a = s21_mul(src1, src2, &temp);
    ck_assert_int_eq(a, 1);
}
...
START_TEST(s21_mul_test_15) {
    s21_decimal src1 = {{0xffffffff, 0xffffffff, 0, 28 << 16}};
    s21_decimal src2 = {{0xffffffff, 0xffffffff, 0, 28 << 16}};
    s21_decimal temp = {{0, 0, 0, 0}};
    int a = s21_mul(src1, src2, &temp);
    ck_assert_int_eq(a, 0);
}
...
START_TEST(s21_div_test_10) {
    s21_decimal src1 = {{0, 0, 0, 0}}, src2 = {{0xffffffff, 0xffffffff, 0xffffffff, 0}};
    s21_decimal temp = {{0, 0, 0, 0}};
...
START_TEST(s21_div_test_12) {
    s21_decimal src1 = {{0x80000000, 0x80000000, 0x80000000, 0}}, src2 = {{2, 0, 0, 28 << 16}};
    s21_decimal temp = {{0, 0, 0, 0}};
    int a = s21_div(src1, src2, &temp);
    ck_assert_int_eq(a, 1);
}
...
START_TEST(s21_div_test_14) {
    s21_decimal src1 = {{0xffffffff, 0xffffffff, 0xffffffff, 0}}, src2 = {{2, 2, 2, 2}};
    s21_decimal temp = {{0, 0, 0, 0}};
    int a = s21_div(src1, src2, &temp);
    ck_assert_int_eq(a, 0);
}
...
START_TEST(s21_is_less_or_equal_test) {
    ...
    s21_negate(dst1, &dst1);
    ck_assert_int_eq(s21_is_less_or_equal(dst1, dst2), 0);  //  1.2345 <= -1.2 // fail
    ck_assert_int_eq(s21_is_less_or_equal(dst2, dst1), 1);  //  -1.2 <= 1.2345
...
START_TEST(s21_is_greater_or_equal_test) {
    ...
    s21_negate(dst1, &dst1);
    ck_assert_int_eq(s21_is_greater_or_equal(dst1, dst2), 1);  //  1.2345 >= -1.2 // fail
    ck_assert_int_eq(s21_is_greater_or_equal(dst2, dst1), 0);  //  -1.2 >= 1.2345
...
int main(void) {
    ...
    TCase *s21_add_p_18 = tcase_create("s21_add");
    suite_add_tcase(suite, s21_add_p_18);
    tcase_add_test(s21_add_p_18, s21_add_test_18);

    TCase *s21_add_p_19 = tcase_create("s21_add");
    suite_add_tcase(suite, s21_add_p_19);
    tcase_add_test(s21_add_p_19, s21_add_test_19);
    ...
    TCase *s21_sub_p_10 = tcase_create("s21_sub");
    suite_add_tcase(suite, s21_sub_p_10);
    tcase_add_test(s21_sub_p_10, s21_sub_test_10);
    ...
    TCase *s21_sub_p_13 = tcase_create("s21_sub");
    suite_add_tcase(suite, s21_sub_p_13);
    tcase_add_test(s21_sub_p_13, s21_sub_test_13);

    TCase *s21_sub_p_14 = tcase_create("s21_sub");
    suite_add_tcase(suite, s21_sub_p_14);
    tcase_add_test(s21_sub_p_14, s21_sub_test_14);
    ...
    TCase *s21_mul_p_13 = tcase_create("s21_mul");
    suite_add_tcase(suite, s21_mul_p_13);
    tcase_add_test(s21_mul_p_13, s21_mul_test_13);

    TCase *s21_mul_p_14 = tcase_create("s21_mul");
    suite_add_tcase(suite, s21_mul_p_14);
    tcase_add_test(s21_mul_p_14, s21_mul_test_14);

    TCase *s21_mul_p_15 = tcase_create("s21_mul");
    suite_add_tcase(suite, s21_mul_p_15);
    tcase_add_test(s21_mul_p_15, s21_mul_test_15);
    ...
    TCase *s21_div_p_11 = tcase_create("s21_div");
    suite_add_tcase(suite, s21_div_p_11);
    tcase_add_test(s21_div_p_11, s21_div_test_11);
    ...
    TCase *s21_mod_p_1 = tcase_create("s21_mod");
    suite_add_tcase(suite, s21_mod_p_1);
    tcase_add_test(s21_mod_p_1, s21_mod_test_1);

    TCase *s21_mod_p_2 = tcase_create("s21_mod");
    suite_add_tcase(suite, s21_mod_p_2);
    tcase_add_test(s21_mod_p_2, s21_mod_test_2);

    TCase *s21_mod_p_3 = tcase_create("s21_mod");
    suite_add_tcase(suite, s21_mod_p_3);
    tcase_add_test(s21_mod_p_3, s21_mod_test_3);

    TCase *s21_mod_p_4 = tcase_create("s21_mod");
    suite_add_tcase(suite, s21_mod_p_4);
    tcase_add_test(s21_mod_p_4, s21_mod_test_4);

    TCase *s21_mod_p_5 = tcase_create("s21_mod");
    suite_add_tcase(suite, s21_mod_p_5);
    tcase_add_test(s21_mod_p_5, s21_mod_test_5);

    TCase *s21_mod_p_6 = tcase_create("s21_mod");
    suite_add_tcase(suite, s21_mod_p_6);
    tcase_add_test(s21_mod_p_6, s21_mod_test_6);

    TCase *s21_mod_p_7 = tcase_create("s21_mod");
    suite_add_tcase(suite, s21_mod_p_7);
    tcase_add_test(s21_mod_p_7, s21_mod_test_7);

    TCase *s21_mod_p_8 = tcase_create("s21_mod");
    suite_add_tcase(suite, s21_mod_p_8);
    tcase_add_test(s21_mod_p_8, s21_mod_test_8);
    ...
    TCase *s21_from_float_to_decimal_p = tcase_create("s21_from_float_to_decimal_p");
    suite_add_tcase(suite, s21_from_float_to_decimal_p);
    tcase_add_test(s21_from_float_to_decimal_p, s21_from_float_to_decimal_1);

    TCase *s21_from_float_to_decimal_p_7 = tcase_create("s21_from_float_to_decimal_p_7");
    ...
    TCase *s21_from_float_to_decimal_p_8 = tcase_create("s21_from_float_to_decimal_p_8");
    ...
    TCase *s21_from_float_to_decimal_p_9 = tcase_create("s21_from_float_to_decimal_p_9");
